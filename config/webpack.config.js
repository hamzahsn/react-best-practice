...
const IS_PERF = process.env.NODE_ENV === 'performance'
...
module.exports = {
    ...
    rules: [
      {
        ...
        use: {
          loader: 'babel-loader',
          options: {
            presets: [['@babel/preset-env', { modules: false, loose: true, targets }], '@babel/preset-react', '@babel/preset-typescript'],
            plugins: [
  ...
  plugins: [
    new CopyWebpackPlugin({
      patterns: [{ from: paths.root + '/public/mockServiceWorker.js' }]
    }),
